...
_OPTIONS_READ=bash-4.4.12_2
_FILE_COMPLETE_OPTIONS_LIST=COLONBREAKSWORDS DOCS FDESCFS HELP NLS STATIC SYSLOG
OPTIONS_FILE_SET+=COLONBREAKSWORDS
OPTIONS_FILE_SET+=DOCS
OPTIONS_FILE_UNSET+=FDESCFS
...
_OPTIONS_READ=w3m-0.5.3.20170102
