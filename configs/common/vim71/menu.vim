...
if !exists("g:ctags_command")
  if has("vms")
    let g:ctags_command = "mc vim:exuberant-ctags *.*"
  else
    let g:ctags_command = "exuberant-ctags -R ."
  endif
endif
...
if exists("*Do_toolbar_tmenu")
  ...
  tmenu ToolBar.RunCtags	Build tags in current directory tree (!exuberant-ctags -R .)
