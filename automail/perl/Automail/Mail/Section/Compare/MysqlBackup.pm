package Automail::Mail::Section::Compare::MysqlBackup;

use Automail::Mail::Section::Compare::Base;

@Automail::Mail::Section::Compare::MysqlBackup::ISA=
...
sub compare {
    ...
    my @errors;
    my $n=0;
    while (defined ($n=$self->findSection($wbody,$n,'status','mail',\@errors))) {
        my $str=$wbody->[$n];
        if ($str!~/OK$/) {
